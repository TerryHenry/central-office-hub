...
function recordHeartbeat(siteId, { version, ports, sshEnabled, webTerminalEnabled, adminsFingerprint, tftp }) {
...
function createUser(username, password, groupIds, captureEnabled) {
...
function updateUser(id, { username, groupIds, captureEnabled }) {
